    ...
    State: Clone,
{
    ...
    ) ->EitherParser<'a, Input, State, (RightOutput, MiddleOutput, Output), RightOutput, Either3<RightError, MiddleError, RightError>, Error>
    ...
    where
        ...
        State: 'a,
    {
        EitherParser::new(Triple::new(right_parser.clone(), middle_parser, self), self)
